...
const Home = () => {
  ...
  <div className="w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10">
    ...
    <div
  className="w-full h-full absolute opacity-10 mix-blend-color-dodge translate-z-0"
  style={{
...
></div>
      ...
      <motion.div 
        ...
        className="w-full h-full max-w-[650px] max-h-[600px] absolute -bottom-16 right-28 lg:bottom-0 lg:right-[12%]">
        <Avatar />
      </motion.div>
